...
package body CHelper is
   ...
   function "="
     (Left: in C.Strings.chars_ptr; Right: in String) return Boolean is
   begin --  "="
      return Value(Left) = Right;
   end "=";

   function "="
     (Left: in String; Right: in C.Strings.chars_ptr) return Boolean is
   begin --  "="
      return Left = Value(Right);
   end "=";
   ...
   function "*"(Left: Natural; Right: Character) return C.Strings.chars_ptr is
   ...
   function "*"
     (Left: Natural; Right: C.Strings.chars_ptr) return C.Strings.chars_ptr is
      Result: constant C.Strings.char_array_access :=
   ...
   function Count
     (Source: C.Strings.chars_ptr; Pattern: String;
   ...
   function Count
     (Source: C.Strings.chars_ptr; Set: Ada.Strings.Maps.Character_Set)
      return Natural is
   begin --  Count
   ...
   function Delete
     (Source: C.Strings.chars_ptr; From: Positive; Through: Natural)
   ...
   function Element
     (Source: C.Strings.chars_ptr; Index: Positive) return Character is
   begin --  Element
   ...
   procedure Find_Token
     (Source: C.Strings.chars_ptr; Set: Ada.Strings.Maps.Character_Set;
      Test: Ada.Strings.Membership; First: out Positive; Last: out Natural) is
   begin --  Find_Token
   ...
   function Head
     (Source: C.Strings.chars_ptr; Count: Natural;
      Pad: Character := Ada.Strings.Space) return C.Strings.chars_ptr is
   begin --  Head
      return C.Strings.New_String
   ...
   function Index
     (Source: C.Strings.chars_ptr; Set: Ada.Strings.Maps.Character_Set;
      ...
      Going: Ada.Strings.Direction := Ada.Strings.Forward) return Natural is
   begin --  Index
   ...
   function Insert
     (Source: C.Strings.chars_ptr; Before: Positive; New_Item: String)
      return C.Strings.chars_ptr is
   begin --  Insert
      return C.Strings.New_String
   ...
   function Overwrite
     (Source: C.Strings.chars_ptr; Position: Positive; New_Item: String)
      return C.Strings.chars_ptr is
   begin --  Overwrite
      return C.Strings.New_String
   ...
   procedure Replace_Element
     (Source: in out C.Strings.chars_ptr; Index: Positive; By: Character) is
   ...
   function Replace_Slice
     (Source: C.Strings.chars_ptr; Low: Positive; High: Natural; By: String)
      return C.Strings.chars_ptr is
   begin --  Replace_Slice
      return C.Strings.New_String
   ...
   function Slice
     (Source: C.Strings.chars_ptr; Low: Positive; High: Natural)
      return String is
   ...
   procedure Append
     (Source: in out C.Strings.chars_ptr; New_Item: in C.Strings.chars_ptr) is
   ...
   procedure Append(Source: in out C.Strings.chars_ptr; New_Item: in String) is
      S_Length: constant C.size_t := C.Strings.Strlen(Source);
   ...
   procedure Append
     (Source: in out C.Strings.chars_ptr; New_Item: in Character) is
      S_Length: constant C.size_t := C.Strings.Strlen(Source);
   ...
   function Translate
     (Source: C.Strings.chars_ptr; Mapping: Ada.Strings.Maps.Character_Mapping)
      return C.Strings.chars_ptr is
   begin --  Translate
      return C.Strings.New_String
   ...
   function Trim
     (Source: in C.Strings.chars_ptr; Side: in Ada.Strings.Trim_End)
      return C.Strings.chars_ptr is
   begin --  Trim
      return C.Strings.New_String(Ada.Strings.Fixed.Trim(Value(Source), Side));
   end Trim;

   procedure Trim
     (Source: in out C.Strings.chars_ptr; Side: in Ada.Strings.Trim_End) is
      Temp: C.Strings.chars_ptr := Source;
   begin --  Trim
      Source :=
        C.Strings.New_String(Ada.Strings.Fixed.Trim(Value(Source), Side));
      C.Strings.Free(Temp);
   end Trim;

   function Trim
     (Source: in C.Strings.chars_ptr; Left: in Ada.Strings.Maps.Character_Set;
      Right: in Ada.Strings.Maps.Character_Set) return C.Strings.chars_ptr is
   begin --  Trim
      return C.Strings.New_String
