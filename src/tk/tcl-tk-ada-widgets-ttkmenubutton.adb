...
package body Tcl.Tk.Ada.Widgets.TtkMenuButton is

   function Create
     (pathName: in String; options: in String := "";
      Interp: in Tcl_Interp := Null_Interp) return Ttk_MenuButton is
      The_Widget: Ttk_MenuButton;
   begin
      ...
      Tcl_Eval
        (The_Widget.Interp, "ttk::menubutton " & pathName & " " & options);
      return The_Widget;
   end Create;
   ...
   overriding function Get_Widget
     (pathName: in String; Interp: in Tcl_Interp := Get_Context)
      return Ttk_MenuButton is
   begin
      return New_Button: Ttk_MenuButton do
