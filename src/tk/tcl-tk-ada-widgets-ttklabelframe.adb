...
package body Tcl.Tk.Ada.Widgets.TtkLabelFrame is

   function Create
     (pathName: in String; options: in String := "";
      Interp: in Tcl_Interp := null) return Ttk_LabelFrame is
      The_Widget: Ttk_LabelFrame;
   begin
      if Interp = null then
      ...
      Tcl_Eval(The_Widget.Interp, "ttk::labelframe " & pathName & " " & options);
      return The_Widget;
   end Create;
