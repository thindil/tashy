...
-- SOURCE
package Tcl.Tk.Ada.Widgets.TtkFrame with
   SPARK_Mode
is
...
-- ****
   ...
   overriding function Create
     (pathName: in String; options: in String := "";
      Interp: in Tcl_Interp := Null_Interp) return Ttk_Frame with
      Global => null;
      -- ****
   ...
   overriding procedure Create
     ...
     -- RESULT
     -- Existing Ttk_Frame widget
     -- HISTORY
     -- 8.6.9 - Added
     -- EXAMPLE
     -- -- Get frame widget with name .myframe on the current Tcl interpreter
     -- My_Frame: constant Ttk_Frame := Get_Widget(".myframe");
     -- SOURCE
   overriding function Get_Widget
     (pathName: in String; Interp: in Tcl_Interp := Get_Context)
      return Ttk_Frame with
      Global => null;
     -- ****

private

   type Ttk_Frame is new Tk_Widget with null record;

end Tcl.Tk.Ada.Widgets.TtkFrame;
