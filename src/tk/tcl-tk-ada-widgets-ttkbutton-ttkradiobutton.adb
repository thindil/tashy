...
package body Tcl.Tk.Ada.Widgets.TtkButton.TtkRadioButton is

   function Create
     (pathName: in String; options: in String := "";
      Interp: in Tcl_Interp := Null_Interp) return Ttk_RadioButton is
      The_Widget: Ttk_RadioButton;
   begin
   ...
   overriding function Get_Widget
     (pathName: in String; Interp: in Tcl_Interp := Get_Context)
      return Ttk_RadioButton is
   begin
      return New_Button: Ttk_RadioButton do
