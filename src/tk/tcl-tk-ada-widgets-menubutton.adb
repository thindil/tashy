...
package body Tcl.Tk.Ada.Widgets.MenuButton is

   function Create
     (pathName: in String; options: in String := "";
      Interp: in Tcl_Interp := Null_Interp) return Tk_MenuButton is
      The_Widget: Tk_MenuButton;
   begin
      ...
      Tcl_Eval(The_Widget.Interp, "menubutton " & pathName & " " & options);
      return The_Widget;
   end Create;
